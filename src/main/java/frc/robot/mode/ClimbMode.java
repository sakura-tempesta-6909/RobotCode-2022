...
public class ClimbMode extends Mode {
  ...
  public void changeMode() {
    if(driveController.getPOV() == Const.Xbox.POV90Degrees){
      State.mode = Modes.k_conveyor;
    } else if(driveController.getPOV() == Const.Xbox.POV270Degrees){
  ...
  public void changeState() {
    ...
    if(driveController.getRightStickButton() && driveController.getLeftStickButton() && driveController.getPOV() == Const.Xbox.POV180Degrees){  
